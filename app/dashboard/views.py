...
def dashboard_view(request):
    ...
    monthly_labels = []
    for i in range(6):
        month_start_date = this_month - timedelta(days=30*i)
from django.shortcuts import render
from django.utils import timezone
from datetime import timedelta, datetime
...
def dashboard_view(request):
    ...
    # Debug prints
    print("DEBUG: Sales Trend Data:", sales_trend_data)
    print("DEBUG: Sales Trend Labels:", sales_trend_labels)
    print("DEBUG: Top Products:", top_products)
    print("DEBUG: Category Sales:", category_sales)
    print("DEBUG: Monthly Sales Data:", monthly_sales_data)
    print("DEBUG: Monthly Labels:", monthly_labels)
